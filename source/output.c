...
int output_pk(
  ...
  for (index_z = 0; index_z < pop->z_pk_num; index_z++) {
    ...
    if(pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb.dat");
    //else if(pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb.dat");
      ...
      for (index_ic1 = 0; index_ic1 < ppt->ic_size[index_md]; index_ic1++) {
        ...
        for (index_ic2 = index_ic1; index_ic2 < ppt->ic_size[index_md]; index_ic2++) {
          ...
          if ((ppt->has_ad == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad.dat");
          ...
          if ((ppt->has_bi == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_bi.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_bi.dat");
          ...
          if ((ppt->has_cdi == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_cdi.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_cdi.dat");
          ...
          if ((ppt->has_nid == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_nid.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_nid.dat");
          ...
          if ((ppt->has_niv == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_niv.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_niv.dat");
          ...
          if ((ppt->has_ad == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad_bi.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad_bi.dat");
          ...
          if ((ppt->has_ad == _TRUE_) && (ppt->has_cdi == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad_cdi.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad_cdi.dat");
          ...
          if ((ppt->has_ad == _TRUE_) && (ppt->has_nid == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad_nid.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad_nid.dat");
          ...
          if ((ppt->has_ad == _TRUE_) && (ppt->has_niv == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad_niv.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ad_niv.dat");
          ...
          if ((ppt->has_bi == _TRUE_) && (ppt->has_cdi == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_bi_cdi.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_bi_cdi.dat");
          ...
          if ((ppt->has_bi == _TRUE_) && (ppt->has_nid == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_bi_nid.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_bi_nid.dat");
          ...
          if ((ppt->has_bi == _TRUE_) && (ppt->has_niv == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ni_niv.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_ni_niv.dat");
          ...
          if ((ppt->has_cdi == _TRUE_) && (ppt->has_nid == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_cdi_nid.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_cdi_nid.dat");
          ...
          if ((ppt->has_cdi == _TRUE_) && (ppt->has_niv == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_cdi_niv.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_cdi_niv.dat");
          ...
          if ((ppt->has_nid == _TRUE_) && (ppt->has_niv == _TRUE_) &&
            ...
            if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_nid_niv.dat");
            //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_nid_niv.dat");
    ...
    if (pop->z_pk[index_z] == 0.) {
      ...
      for (index_k=0; index_k<psp->ln_k_size; index_k++) {
        ...
        if (psp->ic_size[index_md] == 1) {
          ...
          if (pba->has_ncdm || pba->has_ddec) pk_cb_tot[index_k] = exp(psp->ln_pk_cb[(psp->ln_tau_size-1) * psp->ln_k_size + index_k]);
          //else if (pba->has_ddec) pk_cb_tot[index_k] = exp(psp->ln_pk_cb[(psp->ln_tau_size-1) * psp->ln_k_size + index_k]);
        }
        else {
          pk_tot[index_k] = 0.;
          if (pba->has_ncdm || pba->has_ddec) pk_cb_tot[index_k] = 0.;
          //else if (pba->has_ddec) pk_cb_tot[index_k] = 0.;
    ...
    free(pk_tot);
    if(pba->has_ncdm || pba->has_ddec) free(pk_cb_tot);
    //else if(pba->has_ddec) free(pk_cb_tot);
    fclose(out);
    if(pba->has_ncdm || pba->has_ddec) fclose(out_cb);
    //else if(pba->has_ddec) fclose(out_cb);

    if (psp->ic_size[index_md] > 1) {
      for (index_ic1_ic2 = 0; index_ic1_ic2 < psp->ic_ic_size[index_md]; index_ic1_ic2++) {
        if (psp->is_non_zero[index_md][index_ic1_ic2] == _TRUE_) {
          fclose(out_ic[index_ic1_ic2]);
          if(pba->has_ncdm || pba->has_ddec) fclose(out_cb_ic[index_ic1_ic2]);
          //else if(pba->has_ddec) fclose(out_cb_ic[index_ic1_ic2]);
        }
      }
      free(out_ic);
      if(pba->has_ncdm || pba->has_ddec) free(out_cb_ic);
      //else if(pba->has_ddec) free(out_cb_ic);
      free(pk_ic);
      if(pba->has_ncdm || pba->has_ddec) free(pk_cb_ic);
      //else if(pba->has_ddec) free(pk_cb_ic);
    }
  }
...
int output_pk_nl(
  ...
  for (index_z = 0; index_z < pop->z_pk_num; index_z++) {
    ...
    if (pba->has_ncdm || pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_nl.dat");
    //else if (pba->has_ddec) sprintf(file_cb_name,"%s%s%s",pop->root,redshift_suffix,"pk_cb_nl.dat");
    ...
    if (pop->z_pk[index_z] == 0.) {
      ...
      for (index_k=0; index_k<psp->ln_k_size; index_k++) {
        ...
        if (pba->has_ncdm || pba->has_ddec) pk_cb_tot[index_k] = exp(psp->ln_pk_cb_nl[(psp->ln_tau_nl_size-1) * psp->ln_k_size + index_k]);
        //else if (pba->has_ddec) pk_cb_tot[index_k] = exp(psp->ln_pk_cb_nl[(psp->ln_tau_nl_size-1) * psp->ln_k_size + index_k]);
