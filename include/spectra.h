...
struct spectra {
  ...
  int index_tr_delta_ddec1;    /**< (ddec) index of first species of non-cold dark matter (massive neutrinos, ...) density transfer function */
  ...
  int index_tr_theta_ddec1;    /**< (ddec) index of first species of non-cold dark matter (massive neutrinos, ...) velocity transfer function */
