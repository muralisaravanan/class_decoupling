...
struct background
{
  ...
  int N_ddec;                            /**< Number of distinguishable ncdm (ddec) species */
  double * M_ddec;                       /**< vector of masses of non-cold relic:
                                             dimensionless ratios m_ddec/T_ddec */
  double * Omega0_ddec, Omega0_ddec_tot; /**< Omega0_ddec for each species and for the total Omega0_ddec */
  double * deg_ddec, deg_ddec_default;   /**< vector of degeneracy parameters in factor
                                             of p-s-d: 1 for one family of neutrinos
                                             (= one neutrino plus its anti-neutrino,
                                             total g*=1+1=2, so deg = 0.5 g*); and its
					     default value */

  /* the following parameters help to define the analytical ncdm (ddec) phase space distributions (p-s-d) */
  double * T_ddec,T_ddec_default;       /**< list of 1st parameters in
					     p-s-d of non-cold relics:
					     relative temperature
					     T_ddec1/T_gamma; and its
					     default value */
  // ddec specific lines start
  double * zdec_ddec,zdec_ddec_default;
  double * dzdec_ddec,dzdec_ddec_default;
  int * ddec_fermion_boson,ddec_fermion_boson_default;
  // ddec specific end
  double * ksi_ddec, ksi_ddec_default;  /**< list of 2nd parameters in
					     p-s-d of non-cold relics:
					     relative chemical potential
					     ksi_ddec1/T_ddec1; and its
					     default value */
  double * ddec_psd_parameters;         /**< list of parameters for specifying/modifying
                                             ncdm (ddec) p.s.d.'s, to be customized for given model
                                             (could be e.g. mixing angles) */
  /* end of parameters for analytical ncdm (ddec) p-s-d */

  /* the following parameters help to define tabulated ncdm (ddec) p-s-d passed in file */
  char * ddec_psd_files;                /**< list of filenames for tabulated p-s-d */
  /* end of parameters for tabulated ncdm (ddec) p-s-d */
  ...
  double * m_ddec_in_eV; /**< list of ncdm (ddec) masses in eV (inferred from M_ddec and other parameters above) */
  ...
  int index_bg_rho_ddec1;     /**< density of first ncdm (ddec) species (others contiguous) */
  int index_bg_p_ddec1;       /**< pressure of first ncdm (ddec) species (others contiguous) */
  int index_bg_pseudo_p_ddec1;/**< another statistical momentum useful in ncdma approximation */
  ...
  short has_ddec;      /**< presence of non-cold dark matter (ddec)? */
  ...
  //@{
  int * ddec_quadrature_strategy; /**< Vector of integers according to quadrature strategy. */
  int * ddec_input_q_size; /**< Vector of numbers of q bins */
  double * ddec_qmax;   /**< Vector of maximum value of q */
  double ** q_ddec_bg;  /**< Pointers to vectors of background sampling in q */
  double ** w_ddec_bg;  /**< Pointers to vectors of corresponding quadrature weights w */
  double ** q_ddec;     /**< Pointers to vectors of perturbation sampling in q */
  double ** w_ddec;     /**< Pointers to vectors of corresponding quadrature weights w */
  double ** dlnf0_dlnq_ddec; /**< Pointers to vectors of logarithmic derivatives of p-s-d */
  int * q_size_ddec_bg; /**< Size of the q_ddec_bg arrays */
  int * q_size_ddec;    /**< Size of the q_ddec arrays */
  double * factor_ddec; /**< List of normalization factors for calculating energy density etc.*/
