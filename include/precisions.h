...
//class_precision_parameter(tol_M_ddec,double,1.e-10)
class_precision_parameter(tol_M_ddec,double,1.e-7)
/**
...
//class_precision_parameter(tol_ddec,double,1.e-10)
class_precision_parameter(tol_ddec,double,1.e-3)
/**
 * Tolerance on the relative precision of the integration over
...
//class_precision_parameter(tol_ddec_synchronous,double,1.e-10)
class_precision_parameter(tol_ddec_synchronous,double,1.e-3)
/**
 * Tolerance on the relative precision of the integration over
...
//class_precision_parameter(tol_ddec_newtonian,double,1.e-10)
class_precision_parameter(tol_ddec_newtonian,double,1.e-5)
/**
 * Tolerance on the relative precision of the integration over
...
//class_precision_parameter(tol_ddec_bg,double,1.e-10)
class_precision_parameter(tol_ddec_bg,double,1.e-5)
/**
...
//class_precision_parameter(tol_ddec_initial_w,double,1.e-10)
class_precision_parameter(tol_ddec_initial_w,double,1.e-3)
// ddec end
/**
...
class_precision_parameter(start_large_k_at_tau_h_over_tau_k,double,0.0007)  /**< largest wavelengths start being sampled when mode is sufficiently outside Hubble scale. This is quantified in terms of the ratio of hubble time scale to wavenumber time scale, \f$ \tau_h/\tau_k \f$ which is roughly equal to (k*tau). Start when this ratio equals start_large_k_at_tau_k_over_tau_h. Decrease this value to start integrating the wavenumbers earlier in time. */
...
class_precision_parameter(l_max_ddec,int,17)   /**< (ddec) number of momenta in Boltzmann hierarchy for relativistic neutrino/relics (scalar), at least 4 */
...
class_precision_parameter(ddec_fluid_approximation,int,ncdmfa_CLASS) /**< (ddec) method for non-cold dark matter fluid approximation */

/**
 * when to switch off ncdm (massive neutrinos / non-cold
 * relics) fluid approximation
 */
class_precision_parameter(ncdm_fluid_trigger_tau_over_tau_k,double,81.0)
class_precision_parameter(ddec_fluid_trigger_tau_over_tau_k,double,32.0)
